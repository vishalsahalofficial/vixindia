...
public class SignupController {
    ...
    public ResponseEntity<?> sendOTPForSignup(@RequestBody MobileVerificationRequest mobileVerificationRequest) {
        try {
    ...
    public ResponseEntity<?> verifyOTPForSignup(@RequestBody MobileValidationRequest mobileValidationRequest) {
        try {
