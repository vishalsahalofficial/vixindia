...
public class SignupDaoImpl implements SignupDao {
    ...
    public Map<String, Object> getMobileVeificationOTPCount(Long mobileNumber) {
        try {
            ...
            return jdbcTemplate.getJdbcTemplate().queryForMap(sql, new MapSqlParameterSource().addValue("mobileNumber", mobileNumber));
    ...
    public void sendBorrowerMobileOtp(Long mobileNumber, String OTP) {
        ...
        String updateOtpSql = "update user_verification set mobile_otp=:otpToken,mobile_otp_update_time=current_timestamp(), " +
                " otp_sent_try_count=otp_sent_try_count+1 where mobile_number=:mobileNumber";
        String insertOtpSql = "insert into user_verification(mobile_number,mobile_otp,mobile_otp_update_time, " +
...
//inserting
    ...
    public void updateTryCount(String mobileNumber) {
        ...
        String sql2 = "update user_verification set mobile_otp_try_count=mobile_otp_try_count+1 where mobile_number = '" + mobileNumber + "'";
    ...
    public void setMobileVerified(String mobileNumber) {
        String sql1 = "SET SQL_SAFE_UPDATES=0;";
        String sql2 = "update user_verification set is_mobile_registered=1, is_otp_verified=1 where mobile_number='" + mobileNumber + "'";
        String sql3 = "SET SQL_SAFE_UPDATES=1;";
        jdbcTemplate.getJdbcTemplate().batchUpdate(sql1, sql2, sql3);
    }
    ...
    public void isMobileNumberAlreadyVerified(Long mobileNumber) {
        ...
        try {
            String sql = "select is_mobile_registered from user_verification where mobile_number = '" + mobileNumber + "'";
            ...
            if (isMobileVerified) {
                throw new GlobalException(HttpStatus.BAD_REQUEST.value(), "Already Verified", new ArrayList<>());
            }
    ...
    public Long insertProfile(String name, Long mobileNumber) {
        ...
        try {
            ...
            return Objects.requireNonNull(keyHolder.getKey(), "User creation failed due either Mobile number not verified or database issues").longValue();
        } catch (DataAccessException e) {
            return null;
        }
    }
